...
var Yt = class {
  constructor() {
    ...
    x(this, "create", (o) => {
      var b;
      const { message: e, ...a } = o, m = typeof o.id == "number" || o.id && ((b = o.id) == null ? void 0 : b.length) > 0 ? o.id : pt++, c = this.toasts.find((d) => d.id === m), g = o.dismissible === void 0 ? true : o.dismissible;
...
function _t(r, o) {
  return openBlock(), createElementBlock("svg", Wt, jt);
}
var Kt = G(Rt, [["render", _t]]);
var Xt = () => {
  const r = ref(false);
  return watchEffect(() => {
    const o = () => {
...
var oe = defineComponent({
  ...
  setup(r, { emit: o }) {
    const e = o, a = r, m = ref(false), c = ref(false), g = ref(false), b = ref(false), d = ref(0), O = ref(0), D = ref(null), E = ref(null), z = computed(() => a.index === 0), A = computed(() => a.index + 1 <= a.visibleToasts), T = computed(() => a.toast.type), j = computed(() => a.toast.dismissible !== false), lt = computed(() => {
      var t, i, y, S, w, h, M;
      return a.cn(
    ...
    ), n = ref(0), u = ref(0), B = ref(s.value), $ = ref(0), v = ref(null), L = computed(() => a.position.split("-")), q = computed(() => L.value[0]), J = computed(() => L.value[1]), Q = typeof a.toast.title != "string", tt = typeof a.toast.description != "string", et = computed(() => a.heights.reduce((t, i, y) => y >= Z.value ? t : t + i.height, 0)), at = Xt(), ot = computed(() => a.toast.invert || a.invert), U = computed(() => T.value === "loading");
    onMounted(() => {
      if (!m.value)
        return;
    ...
    const I = () => {
      ...
      if (Math.abs(i) >= ee || S > 0.11) {
        d.value = u.value, (M = (h = a.toast).onDismiss) == null || M.call(h, a.toast), I(), b.value = true;
        return;
      }
    ...
    return watchEffect(() => {
      ...
      return openBlock(), createElementBlock("li", {
        ...
        ct.value && !t.toast.component ? (openBlock(), createElementBlock("button", {
          ...
          "data-close-button": "",
          class: normalizeClass(t.cn((S = t.classes) == null ? void 0 : S.closeButton, (h = (w = t.toast) == null ? void 0 : w.classes) == null ? void 0 : h.closeButton)),
          onClick: ut
        }, [
          createVNode(Kt)
        ...
        t.toast.component ? (openBlock(), createBlock(resolveDynamicComponent(t.toast.component), mergeProps({ key: 1 }, t.toast.componentProps, { onCloseToast: I }), null, 16)) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [
          ...
          createBaseVNode("div", Jt, [
            createBaseVNode("div", {
              ...
              Q ? (openBlock(), createBlock(resolveDynamicComponent(t.toast.title), normalizeProps(mergeProps({ key: 0 }, t.toast.componentProps)), null, 16)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            t.toast.description ? (openBlock(), createElementBlock("div", {
              ...
              tt ? (openBlock(), createBlock(resolveDynamicComponent(t.toast.description), normalizeProps(mergeProps({ key: 0 }, t.toast.componentProps)), null, 16)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
...
var Le = defineComponent({
  ...
  setup(r) {
    ...
    }), b = ref([]), d = ref(false), O = ref(false), D = ref(
